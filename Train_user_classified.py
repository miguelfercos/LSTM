...
tpot = TPOTClassifier(generations=5, population_size=50, scoring='accuracy', cv=5, max_time_mins=380, max_eval_time_mins=60, early_stop=2, n_jobs=2,verbosity=2)
tpot.fit(X_train,y_train)
tpot.export('C:\\Users\\yo\\Dropbox\\Pruebas challenge\\tpot_user_train.py')
